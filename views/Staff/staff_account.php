                ...
                <div class="card card-purple card-outline">
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                <b>Drection: </b> <a class="float-right"><?php echo $row->direction; ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="update_Profile">
                                <form method="post" action="Staff.php?page=update" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="tab-pane" id="Change_Password">
                                <form method="post" action="Staff.php?page=pass" class="form-horizontal">
                                    <div class="form-group row">
                                        <label for="inputName" class="col-sm-2 col-form-label">Old Password</label>
                                        <div class="col-sm-10">
                                            <input type="password" name="oldpassword11" class="form-control" required id="inputName">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="password" name="passwordconfirm11" class="form-control" required id="inputName2">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="offset-sm-2 col-sm-10">
