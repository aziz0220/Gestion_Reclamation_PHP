                        ...
                        <table id="export" class="table table-hover table-bordered table-striped">
                            ...
                            while ($row = $res->fetch_object()) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row->client_national_id; ?></td>
                                    <td><?php echo $row->client_phone; ?></td>
                                    <td><?php echo $row->client_number; ?></td>
                                    <td><?php echo $row->client_email; ?></td>
                                    <td><?php echo $row->client_adr; ?></td>
                                    <td><?php echo $row->created_at; ?></td>
                                    <td><?php echo $row->treated_at; ?></td>
                                    <td>
                                        <a class="btn btn-success btn-sm" href="Admin.php?rec_id=<?php echo $row->rec_id; ?>">
                                            <i class="fas fa-cogs"></i>
                                            Manage
                                        </a>
                                        <a class="btn btn-danger btn-sm delete-btn" data-id="<?php echo $row->rec_id; ?>" href="Admin.php?deleteReclamation=<?php echo $row->rec_id; ?>">
