            ...
            <div class="col-md-3">
                <div class="card card-purple card-outline">
                    <div class="card-body box-profile">
                        ...
                        <p class="text-muted text-center">@Admin STB </p>
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                <b>Number: </b> <a class="float-right"><?php echo $row->tel; ?></a>
                            </li>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="update_Profile">
                                <form method="post" action="Admin.php?page=update" class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" required readonly name="tel" value="<?php echo $row->tel; ?>" id="inputName2">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                            ...
                            <div class="tab-pane" id="Change_Password">
                                <form method="post" action="Admin.php?page=password" class="form-horizontal">
                                    <div class="form-group row">
                                        <label for="inputName" class="col-sm-2 col-form-label">Old Password</label>
                                        <div class="col-sm-10">
                                            <input type="password" name="oldpassword" class="form-control" required id="inputName">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="password" name="passwordconfirm" class="form-control" required id="inputName2">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="offset-sm-2 col-sm-10">
