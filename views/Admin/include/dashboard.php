...
<head>
    ...
    <?php include("views/Admin/include/nav.php"); ?>
    <?php include("views/Admin/include/navigator.php"); ?>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <li class="breadcrumb-item"><a href="Admin.php?page=view_complaints"><?= $ref2; ?></a></li>
